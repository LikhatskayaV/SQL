...
-- 15. Вывести зарплаты Java разработчиков??????????????????????????? убрать эмплоиз
...
-- 23. Вывести минимальную ЗП QA инженеров ПРОВЕРИТЬ!!!!!!!!!!!!!!!
...
-- 28. Вывести фонд (сумму) зарплаты разработчиков. ПРОВЕРИТЬ!!!!
select sum(monthly_salary) from
employee_salary join salary 
on employee_salary.salary_id = salary.id  
join roles_employee
